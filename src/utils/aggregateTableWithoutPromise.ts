...
function aggregateTableDataSimple(table: TableObject[], dimensions: string[], sumResources: string[], uniqueResources: string[], concatenatedResources: string[]): TableObject[] {
...
export {aggregateTableDataSimple}