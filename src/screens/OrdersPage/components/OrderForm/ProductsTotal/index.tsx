    ...
    return (
        <div className="order-products-total">
           <ul className='order-products-total__list'>
               ...
               <li className='order-products-total__list-item'>COD :<span className='order-products-total__list-item__value'>{Math.round(productsInfo.cod*100)/100}</span><span className='currency'>{productsInfo.currency ? productsInfo.currency : ''}</span></li>
