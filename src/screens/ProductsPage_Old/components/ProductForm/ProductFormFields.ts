...
export const FormFieldsGeneral = ({countries, isNew=false,  handleAdditionalServiceChange}: { countries: OptionType[], isNew: boolean, handleAdditionalServiceChange: (val:React.ChangeEvent<HTMLInputElement>)=>void }) => {
    return [
        {
