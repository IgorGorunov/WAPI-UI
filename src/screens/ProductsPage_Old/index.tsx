...
const ProductsPage = () => {
    ...
    return (
        <Layout hasFooter>
            ...
            {showImportModal &&
                <Modal title={`Import xls`} onClose={()=>{onImportModalClose(); fetchData();}} >
                    <ImportFilesBlock file='Master data.xlsx' importFilesType={ImportFilesType.PRODUCTS} closeModal={() => { setShowImportModal(false); fetchData(); }} />
                </Modal>
            }
