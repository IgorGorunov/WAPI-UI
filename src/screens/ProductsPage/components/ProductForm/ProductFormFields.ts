...
export const FormFieldsGeneral = (
    {
        ...
        isNew=false,
        needCertificate,
        productTypeGroupOptions,
        onProductTypeGroupChange,
        productTypeOptions,
        ...
        productTypeGroupOptions: OptionType[],
        onProductTypeGroupChange: (val: string) => void,
    ...
    return [
        ...
        },
        {
            ...
            label: "Category",
            options: productTypeGroupOptions,
            placeholder: "",
            rules: {
                required: "Required field",
            },
            ...
            onChange: onProductTypeGroupChange,
            // onlyAllowedSymbols: true,
        },
        {
            fieldType: FormFieldTypes.SELECT,
        ...
        },
        {
            ...
            errorMessage: "Required field",
            width: isNew ? WidthType.w67 : WidthType.w50,
            classNames: "",
