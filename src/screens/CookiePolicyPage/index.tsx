        ...
        <Layout hasFooter>
            <div className="cookie-policy-page__container">
                ...
                <div className="cookie-policy-page__text-wrapper">
                    <p>{t('text1-1')} <Link className='is-link' href='/'>{t('text1-link')}</Link>{t('text1-2')}</p>
                    <p className='text-bold'>{t('text2')} </p>

                    <p>{t('text3')}</p>
                    <p className='text-bold'>{t('text4')} </p>
                    <p>{t('text5')}</p>
                    <ol className='simple-list'>
                        <li><p><span className='text-bold'>{t('list.item1-title')}</span> {t('list.item1-text')}
                        </p></li>
                        <li><p><span className='text-bold'>{t('list.item2-title')}</span> {t('list.item2-text')}</p></li>
                        <li><p><span className='text-bold'>{t('list.item3-title')}</span> {t('list.item3-text')}</p></li>
                    </ol>
                    <p className='text-bold'>{t('text6')}</p>
                    <table className='cookie-policy-page__cookie-list-table'>
                        <thead>
                            <tr>
                                <th><span className='text-bold'>{t('tableColumns.name')}</span></th>
                                <th><span className='text-bold'>{t('tableColumns.type')}</span></th>
                                <th><span className='text-bold'>{t('tableColumns.description')}</span></th>
                                <th><span className='text-bold'>{t('tableColumns.duration')}</span></th>
                        ...
                        <tr>
                            ...
                            <td>{t('essential')}</td>
                            <td>{t('storesConsent')}</td>
                            <td>{t('6Month')}</td>
                        </tr>
                        <tr>
                            <td>token</td>
                            <td>{t('essential')}</td>
                            <td>{t('identifyUserStatus')}</td>
                            <td>{t('session')}</td>
                        </tr>
                        <tr>
                            <td>userStatus</td>
                    ...
                    <p className='text-bold'>{t('text7')}</p>
                    <p>{t('text8')}</p>
                    <p>{t('text9')}</p>
                </div>
            </div>
